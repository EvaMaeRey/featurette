...
background-image: url(https://images.unsplash.com/photo-1479118013749-9f79d55a28d0?auto=format&fit=crop&q=60&w=500&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHBpYW5vfGVufDB8fDB8fHww)
...
#### .tiny[Gina Reynolds | 2023-10-25 |Image credit: Markus Gjengaar, Upsplash]
???
Title 
...
taylor_album_songs %>% 
  ...
  geom_bar(aes(fill = ifelse(mode, "major", "minor")), 
           alpha = .8) + 
